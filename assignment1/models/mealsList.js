...
module.exports.getSeperateMeals = function () {
  ...
  filtered.push(getMeals("Classic Meals"));
  filtered.push(getMeals("Dessert"));
  filtered.push(getMeals("Easy Prep Meals"));
  filtered.push(getMeals("Vegetarian Meals"));
  filtered.push(getMeals("Family-Style Meals"));
